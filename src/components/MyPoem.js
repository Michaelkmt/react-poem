...
export default function MyPoem() {
    return (
        <div>
            <h1 style={{fontSize: styleSheet.fontSize, color: 'orange'}}>SNOW IN THE MORNING!</h1>
            <p style={{color: 'coral', fontSize: '40px', fontFamily: styleSheet.fontFamily, padding: styleSheet.padding}}>
